  ...
  <body>
    <fieldset style="width: 71%">
      ...
      <div class="nameSection" style="margin-top: 15px">
        ...
        <input type="text"  name="second_name"class="form-control @error('second_name') is-invalid @enderror"value="{{old('second_name', $sponser->name)}}"/>
        <input type="text"  name="third_name" class="form-control @error('third_name') is-invalid @enderror" value="{{old('third_name', $sponser->name)}}"/>
        <input type="text"  name="family_name" class="form-control @error('family_name') is-invalid @enderror" value="{{old('family_name', $sponser->name)}}"/>
      ...
      <div class="nationality" style="margin: 15px 0px">
        ...
        <select name="nationality" id="nationality" class="form-control @error('nationality') is-invalid @enderror" >
          <option value="فلسطيني" @if($sponser->nationality == 'فلسطيني') selected @endif>فلسطيني</option>
        </select>
